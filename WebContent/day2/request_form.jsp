...
<form action="request_parameter.jsp">  <!-- action은 데이터를 받을 서버의 url(파일명) -->
	...
	<input type="submit" value="전송(GET)">	<!-- form 태그 요소의 값들을 서버에 제출(전송)합니다. -->
...
<!-- 
Request Method 
GET : 입력데이터를 Query String으로 전달. 문자인코딩은 자동으로 UTF-8 설정   검색(조회)
POST : 입력데이터를 form data로 전달. 문자인코딩은 꼭 설정해줘야 한다. 
